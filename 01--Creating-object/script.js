...
// dot notation
console.log('breakfast property value: ', dailyroutine.breakfast);

// bracket notation with variable
const wakeup = 'rise';
console.log('rise property value: ', dailyroutine[wakeup]);
...
console.log('refreshment property main value:', dailyroutine.refreshment.firstOption);
console.log('refreshment property main value:', dailyroutine.refreshment.secondOption);
dailyroutine.refreshmentSwitch('Dinner time with Family', 'Movie Time with Family');
console.log('refreshment property firstoption value:', dailyroutine.refreshment.firstOption);
console.log('refreshment property secondoption value:', dailyroutine.refreshment.secondOption);
